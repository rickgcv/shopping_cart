	...
	return BaseController.extend("socreation_test.SO_Create.controller.Detail", {
		...
		sendPushMsg:function(createdSOId){
			...
			var createdSoPushPayload={
			  ...
			  var urlval = "so-approval"

			//   $.post( "so-approval", createdSoPushPayload );
			  ...
			  $.ajax({
				...
				method: "POST",
				url: urlval,
				data: createdSoPushPayload
			  })
				.done(function( msg ) {
				  console.log( "Data Saved: " + msg );
				});

			// $.ajax('http://kafka-bridge-ibm.apps.cluster-ef85.dynamic.opentlc.com/topics/so-approval', 
			// {
